...
function setValueField($data, $field, $texarea = false){
...
?>
 ...
 <h2>Editar usuarios <?php echo "<br/>"."*Usuario numero".$user["user_id"]." - ".$user["name"]." ".$user["surname"];?></h2>
 <?php 
